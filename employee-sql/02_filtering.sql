...
6. Identificar empleados menores de 30 años que se encuentren en el nivel ✔️
   salarial más alto (PaymentTier = 3).
7. Obtener los empleados que trabajan en las ciudades de Pune o New Delhi. ✔️
8. Listar empleados con un nivel de experiencia intermedio ✔️
   (entre 1 y 5 años en su dominio actual).
9. Identificar empleados que fueron benchados y posteriormente abandonaron ✔️
   la empresa.
10. Ordenar los empleados por edad de forma descendente para identificar ✔️
